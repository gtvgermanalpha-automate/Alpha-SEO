      ...
      <div className="rounded-xl border border-line bg-white p-8 shadow-sm">
        ...
        <form onSubmit={onSubmit} className="mt-6">
          ...
          <input
            ...
            className="w-full rounded-lg border border-line bg-white px-4 py-3 text-sm text-ink shadow-sm transition-colors focus:border-bronze focus-visible:outline-none focus:ring-2 focus:ring-bronze/25 disabled:bg-neutral-50"
          />
          ...
          <button
            ...
            className="mt-5 w-full rounded-lg bg-ink px-6 py-3 text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-white shadow-sm transition-colors hover:bg-bronze disabled:cursor-not-allowed disabled:opacity-60"
          >
